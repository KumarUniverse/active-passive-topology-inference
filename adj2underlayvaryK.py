...
mat_filename = 'topology_N20_vary_K.mat' #'topology_K4_vary_N.mat'
...
# DEBUG
# print(topo_gt.shape)                # (5, 50)
# print(edge_res_capacities_gt.shape) # (5, 50)
# print(root2leaf_paths_gt.shape)     # (5, 50)
...
for K in range(3, 8):
    for inst_num in range(num_instances):
        instance = topo_gt[K-3][inst_num]  # K-3, instance i
        # Residual capacities of topology instance i.
        edge_res_capacities = edge_res_capacities_gt[K-3][inst_num][0] # K-3, instance i, 0
        ...
        root2leaf_paths = root2leaf_paths_gt[K-3][inst_num] # K-3, instance i
        ...
        subdirectory = "./vary-K/" + "topos-edges-lists-K" + str(K) + "-N20/"
        ...
        subdirectory = "./vary-K/" + "topos-routing-tables-K" + str(K) + "-N20/"
        if not os.path.isdir(subdirectory):
            os.mkdir(subdirectory)
